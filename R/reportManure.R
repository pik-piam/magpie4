...
reportManure<-function(gdx,nutrient="nr"){
  ...
  getNames(tmp0) <- paste0("Resources|",reportingnames(nutrient),"|Manure (Mt ",unit,")")
  getNames(tmp1) <- paste0("Resources|",reportingnames(nutrient),"|Manure|++|",names_tmp1," (Mt ",unit,")")
  getNames(tmp2) <- paste0("Resources|",reportingnames(nutrient),"|Manure|+|",names_tmp2," (Mt ",unit,")")
  tmp3<-dimSums(collapseNames(readGDX(gdx,"ov_manure_confinement")[,,nutrient][,,"level"]),dim=3.1)
  getNames(tmp3)<-paste0("Resources|",reportingnames(nutrient),"|Manure|",reportingnames("confinement"),"|+|",reportingnames(getNames(tmp3))," (Mt ",unit,")")
