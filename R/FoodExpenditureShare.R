...
FoodExpenditureShare<-function(gdx,level="reg",after_shock=TRUE,products="kfo",product_aggr=T){
  foodexpenditure<-FoodExpenditure(gdx,level=level,after_shock=after_shock,products=products, product_aggr=product_aggr)
