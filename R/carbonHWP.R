...
carbonHWP <- function(gdx, file=NULL, level="cell",unit="element"){
  ...
  #ov_hvarea_forestry[,1,] <- ov_hvarea_forestry[,1,]
  ...
  #ov_hvarea_secdforest[,1,] <- ov_hvarea_secdforest[,1,]*5
  ov_hvarea_primforest <- readGDX(gdx,"ov_hvarea_primforest",select = list(type="level"))
  #ov_hvarea_primforest[,1,] <- ov_hvarea_primforest[,1,]*5
  ov_hvarea_other <- readGDX(gdx,"ov_hvarea_other",select = list(type="level"))
  #ov_hvarea_other[,1,] <- ov_hvarea_other[,1,]*5

  ## common ac_sub ####################################################### xxxxxxxxxxxx ######################
  hwp_forestry <- collapseNames(ov_hvarea_forestry[,,ac_sub]*p32_carbon_density_ac[,,ac_sub])
  hwp_forestry <- dimSums(hwp_forestry,dim=3.2)
  hwp_forestry <- add_dimension(hwp_forestry,dim = 3.1,add = "source",nm = "forestry")
  
  hwp_secdforest <- ov_hvarea_secdforest[,,ac_sub]*pm_carbon_density_ac[,,ac_sub]
  ...
  hwp_primforest <- collapseNames(ov_hvarea_primforest*pm_carbon_density_ac[,,"acx"])
#  hwp_primforest <- dimSums(hwp_primforest,dim=3.2)
  ...
  hwp_other <- ov_hvarea_other[,,ac_sub]*pm_carbon_density_ac[,,ac_sub]
