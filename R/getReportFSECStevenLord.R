...
getReportFSECStevenLord <- function(gdx, reportOutputDir, scenario) {
  ...
  region_path <- file.path(dirname(normalizePath(gdx)), "regionmappingFSEC.csv")
  ...
  dietaryIndicators <- getReportDietaryIndicators(gdx, scenario)
