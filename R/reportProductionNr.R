...
#' @description reports production in Nr analoguous to reportProduction
#' 
#' @import magpiesets 
#' @export
#' 
...
reportProductionNr<-function(gdx,detail=FALSE){
  x = collapseNames(production(gdx = gdx,level="regglo",products = readGDX(gdx,"kall"),product_aggr = FALSE,water_aggr = TRUE,attributes = "nr"),collapsedim = "attributes")
