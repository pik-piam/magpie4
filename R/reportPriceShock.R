...
reportPriceShock<-function(gdx){
  if(!is.null(readGDX(gdx,"p15_delta_kcal_pc", react="silent"))){
    ...
    getNames(shock_total_abs)="Food Supply|Calorie Supply|Price Induced Change|Absolute|Total Calories (cal/capita/day)"
    getNames(shock_livestock_abs)="Food Supply|Calorie Supply|Price Induced Change|Absolute|Livestock Calories (cal/cap/day)"
    getNames(shock_others_abs)="Food Supply|Calorie Supply|Price Induced Change|Absolute|Vegetable, Fruits and Nuts Calories (cal/cap/day)"

    getNames(shock_total_relative)="Food Supply|Calorie Supply|Price Induced Change|Relative|Total Calories (cal/cal)"
    getNames(shock_livestock_relative)="Food Supply|Calorie Supply|Price Induced Change|Relative|Livestock Calories (cal/cal)"
    getNames(shock_others_relative)="Food Supply|Calorie Supply|Price Induced Change|Relative|Vegetable, Fruits and Nuts Calories (cal/cal)"
