...
#' into entities e.g. for stackplots. Notice the following hints for the summation symbol placement:
#' \itemize{
...
#'   \item Every subitem containing the same summation symbol in the same level with the
#'   same supercategory name will be summed.
