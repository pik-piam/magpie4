...
NitrogenBudgetNonagland<-function(gdx,level="reg",dir=".",spamfiledirectory=""){
  ...
  out=gdxAggregate(gdx,out,to=level, absolute=TRUE,dir=dir,spamfiledirectory = spamfiledirectory)
