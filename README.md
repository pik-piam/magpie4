...
R package **magpie4**, version **1.104.11**
...
4.x_. doi: 10.5281/zenodo.1158582 (URL: https://doi.org/10.5281/zenodo.1158582), R package version 1.104.11, <URL:
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 1.104.11},
