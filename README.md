...
R package **magpie4**, version **2.15.11**
...
Bodirsky B, Humpenoeder F, Dietrich J, Stevanovic M, Weindl I, Karstens K, Wang X, Mishra A, Beier F, Breier J, Yalew A, Chen D, Biewald A, Wirth S, von Jeetze P, Leip D, Crawford M, Alves M (2024). _magpie4: MAgPIE outputs R package for MAgPIE version 4.x_. R package version 2.15.11, <https://github.com/pik-piam/magpie4>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 2.15.11},
