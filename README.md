...
R package **magpie4**, version **1.72.15**
...
version 4.x_. doi: 10.5281/zenodo.1158582 (URL: http://doi.org/10.5281/zenodo.1158582), R package
version 1.72.15, <URL: https://github.com/pik-piam/magpie4>.
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 1.72.15},
