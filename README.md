...
R package **magpie4**, version **1.75.18**
...
Chen D, Biewald A, Wirth S, von Jeetze P (2020). _magpie4: MAgPIE outputs R package for MAgPIE version 4.x_.
doi: 10.5281/zenodo.1158582 (URL: https://doi.org/10.5281/zenodo.1158582), R package version 1.75.18, <URL:
...
@Manual{,
  ...
  year = {2020},
  note = {R package version 1.75.18},
